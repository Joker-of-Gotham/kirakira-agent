...
intentional Kirakira extension rows: six covered, two partial, and zero
unclassified EAM behavior gaps. Upgrade readiness now expands these behavior
partials into open-work rows so the high structural score is not confused with
final completion.
